...
set LOG="C:\Users\virat.arya\ETG\SoftsDatabase - Documents\Database\Hardmine\Interim_Migration\Rollex\Automator\run_log.txt"
...
python "C:\Users\virat.arya\ETG\SoftsDatabase - Documents\Database\Hardmine\Interim_Migration\Rollex\Code\rollex_builder_lseg.py" >> %LOG% 2>&1
...
cd /d "C:\Users\virat.arya\ETG\SoftsDatabase - Documents\Database\Hardmine\Interim_Migration\Rollex"
...
python "C:\Users\virat.arya\ETG\SoftsDatabase - Documents\Database\Hardmine\Interim_Migration\Rollex\Automator\notify.py" %INGEST_STATUS% %GIT_STATUS% >> %LOG% 2>&1
